 ...
 * Busca todos os nonFungible e filtra por symbol no servidor
 * (o filtro content.metadata.symbol do Helius não é confiável).
 */
...
export default async function handler(req, res) {
  ...
  try {
    ...
    while (page <= 10) {
      ...
      if (!heliusRes.ok) { console.error('[/api/arts] Helius', heliusRes.status); break; }
